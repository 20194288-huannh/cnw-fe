    ...
    return (
        <div>
            <div className={styles.mainProduct}>
                <div className="row  ">
                    <div className={`c-4 ${styles.mainProductContent} ${styles.mainProductDown} ${styles.animateBanner}`}>
                        <a href="/">
                    ...
                    <div className={`c-4 ${styles.mainProductContent} ${styles.animateBanner}`}>
                        <a href="/">
